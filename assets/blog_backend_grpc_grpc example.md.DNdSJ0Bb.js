import{_ as n,c as a,ah as p,o as e}from"./chunks/framework.dXI2wdDN.js";const u=JSON.parse('{"title":"grpc-example 基于gRPC实现的简单rpc框架","description":"","frontmatter":{"title":"grpc-example 基于gRPC实现的简单rpc框架","date":"2020-10-01T00:00:00.000Z","author":"leeyazhou","categories":["grpc"],"tags":["grpc","微服务框架"]},"headers":[],"relativePath":"blog/backend/grpc/grpc example.md","filePath":"blog/backend/grpc/grpc example.md","lastUpdated":1786590561000}'),t={name:"blog/backend/grpc/grpc example.md"};function l(i,s,c,r,o,g){return e(),a("div",{"data-pagefind-body":!0,"data-pagefind-meta":"date:1601510400000"},[...s[0]||(s[0]=[p(`<h2 id="grpc-example" tabindex="-1">grpc-example <a class="header-anchor" href="#grpc-example" aria-label="Permalink to &quot;grpc-example&quot;">​</a></h2><p>基于gRPC实现的简单rpc框架</p><h2 id="配置" tabindex="-1">配置 <a class="header-anchor" href="#配置" aria-label="Permalink to &quot;配置&quot;">​</a></h2><h3 id="属性配置" tabindex="-1">属性配置 <a class="header-anchor" href="#属性配置" aria-label="Permalink to &quot;属性配置&quot;">​</a></h3><p>pom.xml中配置依赖的gRPC版本号</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>	&lt;properties&gt;</span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>option java_package = &quot;com.github.leeyazhou.grpc&quot;;</span></span>
...
<span class="line"><span>mvn protobuf:compile-custom</span></span></code></pre></div><h3 id="公用基础模型类" tabindex="-1">公用基础模型类 <a class="header-anchor" href="#公用基础模型类" aria-label="Permalink to &quot;公用基础模型类&quot;">​</a></h3><p>Invocation.java</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>package com.github.leeyazhou.grpc.core;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>	</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>Response.java</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>package com.github.leeyazhou.grpc.core;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>	}</span></span>
<span class="line"><span></span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="server代码" tabindex="-1">Server代码 <a class="header-anchor" href="#server代码" aria-label="Permalink to &quot;Server代码&quot;">​</a></h3><p>GrpcServer.java</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>package com.github.leeyazhou.grpc.core.server;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span>	}</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>GrpcServerHandler.java负责处理接收到的请求，并转发给ServiceHandler.java处理，处理完成后响应给请求端。</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>package com.github.leeyazhou.grpc.core.server;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>import com.github.leeyazhou.grpc.MessageServiceGrpc.MessageServiceImplBase;</span></span>
<span class="line"><span>import com.github.leeyazhou.grpc.core.Invocation;</span></span>
<span class="line"><span>import com.github.leeyazhou.grpc.core.Response;</span></span>
<span class="line"><span>import com.github.leeyazhou.grpc.core.serializer.JSONSerializer;</span></span>
<span class="line"><span>import com.github.leeyazhou.grpc.core.serializer.Serializer;</span></span>
<span class="line"><span>import com.github.leeyazhou.grpc.RequestGrpcMessage;</span></span>
<span class="line"><span>import com.github.leeyazhou.grpc.ResponseGrpcMessage;</span></span>
...
<span class="line"><span>		return response;</span></span>
<span class="line"><span>	}</span></span>
<span class="line"><span>}</span></span></code></pre></div><p>ServiceHandler.java</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>package com.github.leeyazhou.grpc.core.server;</span></span>
<span class="line"><span></span></span>
...
<span class="line"><span></span></span>
<span class="line"><span>	}</span></span>
<span class="line"><span>}</span></span></code></pre></div><h3 id="client代码" tabindex="-1">Client代码 <a class="header-anchor" href="#client代码" aria-label="Permalink to &quot;Client代码&quot;">​</a></h3><p>GrpcClient.java</p><div class="language- vp-adaptive-theme"><button title="Copy Code" class="copy"></button><span class="lang"></span><pre class="shiki shiki-themes github-light github-dark vp-code" tabindex="0"><code><span class="line"><span>package com.github.leeyazhou.grpc.core.client;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>import java.util.Map;</span></span>
<span class="line"><span>import java.util.concurrent.ConcurrentHashMap;</span></span>
<span class="line"><span></span></span>
<span class="line"><span>import com.github.leeyazhou.grpc.MessageServiceGrpc;</span></span>
<span class="line"><span>import com.github.leeyazhou.grpc.RequestGrpcMessage;</span></span>
<span class="line"><span>import com.github.leeyazhou.grpc.ResponseGrpcMessage;</span></span>
<span class="line"><span>import com.github.leeyazhou.grpc.core.Invocation;</span></span>
<span class="line"><span>import com.github.leeyazhou.grpc.core.Response;</span></span>
...
<span class="line"><span>	}</span></span>
<span class="line"><span>}</span></span></code></pre></div><h2 id="其他" tabindex="-1">其他 <a class="header-anchor" href="#其他" aria-label="Permalink to &quot;其他&quot;">​</a></h2><p>源码地址<a href="https://github.com/leeyazhou/grpc-example" target="_blank" rel="noreferrer">github.com/leeyazhou/grpc-example</a></p>`,44)])])}const h=n(t,[["render",l]]);export{u as __pageData,h as default};
